...
(defn
 ...
 (reduce
  (fn* [p1__63404# p2__63405#] (greater p1__63404# p2__63405#))
  arg
  args))
...
(defn
 ...
 (assert (every? some? (cons arg args)))
 (reduce
  (fn* [p1__63406# p2__63407#] (lesser p1__63406# p2__63407#))
  arg
  args))
...
(defn yearmonth->last-day-date [ym] (.atEndOfMonth ^YearMonth ym))
